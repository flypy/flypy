...
"""
IR interpreter. Run a series of translation phases on a flypy function, and
...
import flypy
from flypy import typeof, jit, functionwrapper, conversion
...
def op_ptradd(interp, obj, addend):
    if isinstance(obj, flypy.runtime.obj.core.Pointer):
        obj = obj.p
...
def handlers(run_phase, env):
    ...
    """
    typeof_arg = Typer(env['flypy.typing.context'], run_phase).typeof
