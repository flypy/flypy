...
"""
flypy compiler backend leveraging pykit.
"""
...
def codegen_init(func, env):
    ...
    env["flypy.state.llvm_func"] = llvm_func
...
def codegen_run(func, env):
    ...
    """
    lfunc = llvm_codegen.translate(func, env, env["flypy.state.llvm_func"])
    return lfunc, env
